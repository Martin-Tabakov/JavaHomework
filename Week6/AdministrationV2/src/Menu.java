...
public class Menu {
    ...
    public static void printWordsMenu() {
        System.out.println("1. Обърнете буквите на думите от масива наобратно и ги визуализирайте на конзолата \n" +
                "2. Изведете броя на повтарящите се символи във всяка една от думите в масива\n" +
                "3. Изведете броя на символите за всяка една дума в масива\n" +
                "4. Изведете броя на повтарящите се думи в масива\n" +
                "5. Връщане към основното меню");
    }
